...
//            $this->assertEquals('createProject', $app2->get_request_url());
    ...
    public function testIndex()
    {
        ...
        $home_html = $this->app->siteHome();
        $this->assertNotEmpty($home_html);
    }

    public function test_project_list()
    {
       $project_list_json = $this->app->projectList();
       $this->assertNotEmpty($project_list_json);
       $project_list = json_decode($project_list_json);
       $this->assertInternalType('array', $project_list);
