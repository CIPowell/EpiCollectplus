/**
 * Formbuilder-specific functions
 */
...
/**
 * the name of the form being edited
 */
 formName = undefined,
 /**
  *has something in the form been changed?
  */
 dirty = false;
...
/**
 *  Add a form with the name formname to the project
 */
...
/**
 *  Set the currently selected form to the form called formName
 */
...
/**
 * Add the error flag to the form formName
 */
...
/**
 * Add the warning flag to fhte form formName
 */
...
/**
 * Clear errors and warnings from the form list
 */
...
/**
 * The Form that allows a user to change the properties of a form (right panel, blue background)
 */
function PropertiesForm(div_id)
{
    //which controls have which properties availble to be edited
    this.settings = {
...
/**
 * Update the Properties form to match the current
 */
